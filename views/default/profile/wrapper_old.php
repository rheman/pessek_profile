    ...
    <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
        ...
        <div class="btn-group" role="group">
            <button type="button" id="following" class="btn btn-default" href="#tab3" data-toggle="tab"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>
                <div class="hidden-xs"><?php echo elgg_echo('gcconnex_profile:portfolio'); ?></div>
            </button>
        </div>
        <div class="btn-group" role="group">
            <button type="button" id="following" class="btn btn-default" href="#tab3" data-toggle="tab"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>
                <div class="hidden-xs"><?php echo elgg_echo('gcconnex_profile:projects'); ?></div>
            </button>
        </div>
        <div class="btn-group" role="group">
            <button type="button" id="following" class="btn btn-default" href="#tab3" data-toggle="tab"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>
...
<div class="profile elgg-col-3of3">
    ...
    <div class="b_extended_profile">
        ...
        echo '<li role="presentation"><a href="#projects" aria-controls="projects" role="tab" data-toggle="tab">' . elgg_echo('gcconnex_profile:projects') . '</a></li>';
        echo '<li role="presentation"><a href="#experience" aria-controls="experience" role="tab" data-toggle="tab">' . elgg_echo('gcconnex_profile:experience') . '</a></li>';
        echo '</ul>';
...
/*echo '<span class="colleague-suggest-field">' . elgg_view("input/text", array(
        ...
        // create the div wrappers and edit/save/cancel toggles for each profile section
            ...
            echo '<div role="tabpanel" class="tab-pane" id="projects">';
            ...
            echo '</div>'; // close div id="#projects"
            
            
            echo '<div role="tabpanel" class="tab-pane" id="experience">';
            ...
            echo '</div>'; // close div id="#experience"
