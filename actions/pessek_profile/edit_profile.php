    ...
    */
    ...
    switch ($section) {
        ...
        case 'education':
            ...
            $diploma = get_input('diploma', 'ERROR: Ask your admin to grep: 5FH13GAHHHS0002.');
            
            $resultobtain = get_input('resultobtain', 'ERROR: Ask your admin to grep: 5FH13GAHHHS0002.');
            $educationurl = get_input('educationurl', 'ERROR: Ask your admin to grep: 5FH13GAHHHS0002.');
            $activity = get_input('activity', 'ERROR: Ask your admin to grep: 5FH13GAHHHS0002.');
            $trainingd = get_input('trainingd', 'ERROR: Ask your admin to grep: 5FH13GAHHHS0002.');
            ...
            $access = (int) get_input('access', 'ERROR: Ask your admin to grep: 5321GDS1111661353BB.');
            ...
            if (is_array($eguid)) {
                foreach ($eguid as $k => $v) {
                    ...
                    $education->diploma = htmlentities($diploma[$k]);
                    $education->resultobtain = htmlentities($resultobtain[$k]);
                    $education->educationurl = htmlentities($educationurl[$k]);
                    $education->activity = htmlentities($activity[$k]);
                    $education->trainingd = htmlentities($trainingd[$k]);
                    $education->imagesite = UnivImageog($education->educationurl);
